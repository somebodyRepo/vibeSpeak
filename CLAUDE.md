...
- **LLM polish**: Multi-provider adapter (`anthropic`, `openai`, `deepseek`, `zhipu`) via `LLM_PROVIDER` env var. Batch and SSE streaming modes.
...
| `LLM_PROVIDER` | One of: `anthropic`, `openai`, `deepseek`, `zhipu` |
